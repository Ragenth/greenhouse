...
const char* ssid = "xperio_C2ABA5";
const char* password = "HelloWorld@6727!#";
...
void handleRoot() {
  String cmd;
cmd += "<!DOCTYPE HTML>\r\n";
cmd+= "<html lang='en'><head><meta http-equiv='refresh' content='60' name='viewport' content='width=device-width, initial-scale=1'/>";
...
cmd+= "<a href=\'dev1=1\' button type='button' class='btn btn-success'>Automatic</button></a> <a href=\'dev1=0\' button type='button' class='btn btn-primary'>Manual</button></a>";
cmd+=           "<h3> </h3>";
cmd+=           "</li>";
cmd+=        "</ul>";
